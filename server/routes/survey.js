...
const startSurvey = function (req, res, next) {
    ...
    Survey.forge()
        ...
        .then(data => {
            return axios.get(`${publicEndpoint}/create`, {
                params: {
                ...
                return axios.post(`${publicEndpoint}/changeJson`, {
                    ...
                    .then(() =>
                        axios.get(`${publicEndpoint}/publish/${response.data.Id}`, {
                            params: {
                                accessKey: accessKey,
                                generateNewId: true
                            }
                    ...
                    .then(() => {
                        return currSurvey.save(survey.format({
                            publishedinfo: {
                                id: response.data.Id,
